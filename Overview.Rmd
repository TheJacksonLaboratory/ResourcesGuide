...
This is an online platform for managing and sharing research projects. It provides a remote data repository for storing and sharing results in a reproducible and reusable manner. We use it mostly for AMP-AD-related projects, but other projects can be hosted there as well. We have a private workspace there that can be accessed [here](https://www.synapse.org/#!Synapse:syn23573590/wiki/). You'd need to register and be added to the Carter Lab team. See the [full resource guide](https://rshiny.jax.org/connect/#/apps/167/access) for more details (under Acquiring and Sharing Data). 
