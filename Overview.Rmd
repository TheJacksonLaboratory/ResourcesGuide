...
/projects/carter-lab/ Projects in this space should aim to follow some basic rules for reproducibility and sharabilty (see below)  
/sdata/carter-lab/ for secured data, same as lab's projects  
...
**tier2** is best used for research project that are developed mainly in [Rstudio Server], as well as "cold data". Can only be accessed with Globus or from RStudio Server (/tier2/carter-lab/)
...
2. Go to https://rstudio.jax.org/  
2. Sign in with your jax credential  
3. Navigate to tier2 space: Click on the three dots in the upper-right corner of the files   management block. In the "go to folder" pop-up enter /tier2/carter-lab/.  

For organization sake, avoid using the space provided with Rstudio Server except as a dumpster/attic. Use tier2 for shareablilty and collaboration.

## Shiny server
Ask IT to add you as a Shiny user. You can log into it either from RStudio Server or https://rshiny.jax.org/connect/

## carterdev
Hosts shiny apps and websites for large collaborative projects.
...
* Version control and backup of the whole project folder.  
...
* [slack](https://jacksonlaboratory.sharepoint.com/sites/IT/SitePages/How-to-use-Slack.aspx): Look for the CarterLabJax workspace and The Jackson Laboratory workspace. Once logged into a woekspace, you can browse and join channels.  
