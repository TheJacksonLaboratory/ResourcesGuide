...
If you want to work on a project in e.g., ```/sdata/```, you can navigate to it at any time: before initializing the interactive session, before calling R.sif, or from inside R.  
