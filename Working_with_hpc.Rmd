...
You can run Rstudio Server on the hpc and access it from a local browser via port 8787. See instructions [here](https://pawseysc.github.io/sc19-containers/08-gui-rstudio/index.html) and [here](https://divingintogeneticsandgenomics.rbind.io/post/run-rstudio-server-with-singularity-on-hpc/).  
