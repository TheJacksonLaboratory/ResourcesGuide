...
See the [Sigularity tutorial here](https://singularity-tutorial.github.io/) and jax tutorial [here](https://jacksonlaboratory.sharepoint.com/sites/ResearchIT/SitePages/Hands-on--Basics-of-working-with-Singularity.aspx) 
...
[Modifying basic R image and running as a pipeline on sumner](https://hpctalk.jax.org/t/running-first-r-pipeline-on-sumner/73)
