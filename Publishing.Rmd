...
Below is an example of a yml file with multiple menus and submenus, as well as links for a shiny app, dropbox, bitbucket/github, a link to email, nd various outputs.
